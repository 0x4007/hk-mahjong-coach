...
- The fully natural extended gate is now wired for manual GitHub Actions dispatch with deterministic
  up-to-20-way sharding and redacted aggregate receipts. The local natural run was interrupted at
  3m58.286s without a final receipt, so remote 500-hand acceptance remains pending.
